...
public class NilaiPASAdapter extends RecyclerView.Adapter<NilaiPASAdapter.NilaiViewHolder>{
    private Context mContext;
    private ArrayList<NilaiPAS> mNilaiList;
    private OnItemClickListener mListener;

    public NilaiPASAdapter(Context mContext, ArrayList<NilaiPAS> mNilaiList) {
    ...
    public void onBindViewHolder(@NonNull NilaiViewHolder holder, int position) {
        NilaiPAS currentItem = mNilaiList.get(position);
